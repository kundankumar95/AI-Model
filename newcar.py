...
class Car:
    ...
    def __init__(self):
        ...
        self.sprite = pygame.image.load(
            'Backend\\Features\\ai-car-simulation\\car.png').convert()
        self.sprite = pygame.transform.scale(
            self.sprite, (CAR_SIZE_X, CAR_SIZE_Y))
        self.rotated_sprite = self.sprite

        self.position = [800, 900]
...
def run_simulation(genomes, config):
    ...
    game_map = pygame.image.load(
        'Backend\\Features\\ai-car-simulation\\map.png').convert()
...
if __name__ == "__main__":
    ...
    config_path = "Backend\\Features\\ai-car-simulation\\config.txt"
